...
class ResourceTests(unittest.TestCase):
    def test_packaged_resources_resolve(self) -> None:
        self.assertTrue(resource_file("rules", "tagging_registry.yml").is_file())
        self.assertTrue(resource_file("rules", "attack_phases.yml").is_file())
        ...
        self.assertTrue(resource_file("web", "index.html").is_file())
        self.assertTrue(resource_file("web", "app.css").is_file())
        self.assertTrue(resource_file("web", "app.js").is_file())
