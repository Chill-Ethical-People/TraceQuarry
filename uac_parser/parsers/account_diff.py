            ...
            if changes:
                events.append(
                    TimelineEvent(
                        ...
                        parser="account_diff",
                        event_category="persistence",
                        event_action="account_modified_since_backup",
                        user=user,
                        uid=info["uid"],
                        file_path="/etc/passwd",
                        severity="medium",
        ...
        if user not in current:
            events.append(
                TimelineEvent(
                    ...
                    parser="account_diff",
                    event_category="persistence",
                    event_action="account_deleted_since_backup",
                    user=user,
                    uid=info["uid"],
                    file_path="/etc/passwd",
                    severity="high",
        ...
        if not old:
            ...
            events.append(
                TimelineEvent(
                    ...
                    host=host,
                    source_path="etc/shadow vs etc/shadow-",
                    source_type="account_diff",
                    parser="account_diff",
                    event_category="persistence",
        ...
        if info["hash"] != old["hash"]:
            ...
            events.append(
                TimelineEvent(
                    ...
                    source_type="account_diff",
                    parser="account_diff",
                    event_category="credential_change",
                    event_action=action,
                    user=user,
                    file_path="/etc/shadow",
                    severity=severity,
        ...
        for member in removed:
            events.append(
                TimelineEvent(
                    ...
                    ttp_flags=["group_member_removed"],
                    mitre=[],
        ...
        if group not in current:
            events.append(
                TimelineEvent(
                    ...
                    ttp_flags=["group_deleted_since_backup"],
                    mitre=[],
