...
def parse_passwd(path: Path, relative: str, host: str = "") -> list[TimelineEvent]:
    ...
    for raw in read_text_lines(path):
        ...
        event = TimelineEvent(
            ...
            confidence="medium",
            tags=tags,
            summary=f"Account observed: {user} uid={uid} shell={shell}",
            raw=raw,
